...
- **Keep-Alive Probes**: Configured Mongoose to inject `keepAliveInitialDelay: 180000` (3 minutes). This sends a TCP heartbeat before the NAT timeout, ensuring the MongoDB Atlas connection is never marked as idle.
