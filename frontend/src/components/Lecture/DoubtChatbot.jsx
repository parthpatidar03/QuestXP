                    ...
                    >
                        ...
                        <div className="px-4 pb-4 pt-2 flex gap-2 shrink-0 border-t border-border bg-surface-2/95">
                            <textarea
                                ...
                                rows={1}
                                disabled={loading}
                                className="flex-1 px-3 py-2.5 rounded-xl text-sm outline-none resize-none transition-colors bg-surface border border-border text-text-primary placeholder:text-text-muted focus:border-primary/50"
                                style={{
                                    maxHeight: 80,
