...
import { Zap, Bell, Search, BookOpenCheck, Moon, Sun, MessageSquare } from 'lucide-react';
...
const NavBar = () => {
    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b border-border bg-surface/95 backdrop-blur">
            ...
            <FeedbackModal open={isFeedbackOpen} onClose={closeFeedback} contextPage={window.location.pathname} />
        </header>
    );
};
