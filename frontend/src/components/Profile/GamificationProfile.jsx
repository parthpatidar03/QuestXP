...
const GamificationProfile = () => {
    ...
    if (error) return (
        <div className="p-6 text-center text-danger">
            <p>{error}</p>
            <button onClick={fetchProfile} className="mt-4 px-4 py-2 bg-surface-3 rounded-clay-sm hover:bg-surface-4 transition-colors">Retry</button>
        </div>
    );
        ...
        <div className="clay-sunk rounded-clay p-6 mb-6">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-clay-lg bg-primary/20 flex items-center justify-center border border-primary/30 relative overflow-hidden">
            ...
            {profileData.nextLevelTitle && (
                <div className="bg-surface-1 rounded-clay-sm p-4 clay-sm mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                    {profileData.unlockedFeatures.length === 0 ? (
                        ...
                        profileData.unlockedFeatures.map(f => (
                            <span key={f} className="px-3 py-1.5 clay-sunk text-xs rounded-md text-text-primary flex items-center gap-1.5">
